  ...
  return (
    <div className='w-[80vw] max-md:w-full mx-auto' id='menu'>
      <div className="max-md:w-[90vw] m-auto">
        ...
        <p className='max-md:text-sm'>Discover a wide variety of dishes crafted with fresh ingredients and bold flavors.
        From quick bites to full meals, explore options that satisfy every craving and taste.
        </p></div>
