  ...
  return (
    <div className='flex max-md:flex-col gap-4 justify-between items-start text-gray-400 max-md:mt-12 mt-28 p-10 bg-stone-800' id='contact'>
      <div className='flex flex-col gap-4 justify-between w-[40vw] max-md:w-full'>
        ...
        <p>Tomato is your go-to food delivery destination for fresh, flavorful meals made with quality ingredients and crafted by trusted kitchens. We bring you a wide variety of cuisines with fast, reliable delivery, easy ordering, and a seamless experience that satisfies every craving.
        </p>
